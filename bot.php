...
bot('sendvideo', ['video' =>'https://t.me/ronkndkn/7', 'chat_id' => file_get_contents("ID"), 'caption' => "𓆰 𝖧𝗂 𝖯𝗋𝗈 𝖶𝗂𝗍𝗁 : @Xx_ZaaK 🇪🇬",
'parse_mode' => "MarkDown", 
'disable_web_page_preview' => true,
'reply_markup' => json_encode(['resize_keyboard' => true, 'keyboard' => [
[["text" =>"• اضـف رقـم - حـذف رقم  •"],["text" =>"• اضـف يـوزر - حـذف يـوزر •"]],
[["text" =>"• بـدء صـيـد - ايـقـاف صـيـد •"],["text" =>"• حـالـة الـبـيـنـج  •"]], 
[["text" =>"• حـذف لـيـسـته •"],["text" =>"• عـرض لـيـسـته •"]],
[["text" =>"• ريـسـت الـبـوت •"],["text" =>"• تـحـديـثـات •"]],
[["text" =>"• الـضـغـطـات •"],["text" =>"• الـارقـام •"]],
...
if ($chat_id == $group) {
	...
	'reply_markup' => json_encode(['resize_keyboard' => true, 'keyboard' => [
	[["text" =>"->"]],
	[["text" =>"• تحديث الصيد  •"],["text" =>"• تحديث البوت   •"]],
	[["text" =>"• تحديث ميدلاين  •"]]],]) ]);
	}}	
if($text == "• تحديث الصيد  •"){
...
if ($chat_id == $group) {
if($text == "• بـدء صـيـد - ايـقـاف صـيـد •"){
bot('sendMessage', ['chat_id' => $chat_id,
'text'=>"⌁ Select button",
'reply_markup'=>json_encode(['inline_keyboard'=>[
